...
class RequestValidatorTest {
    ...
    void testValidateId_happyPath() {
        assertAll("valid IDs should not throw",
    ...
    void testValidateId_not_happyPath() {
        StoreIllegalArgument exception = assertThrows(
                StoreIllegalArgument.class,
                () -> RequestValidator.validateId(-1L)
        );
    ...
    void testValidateString_not_happyPath(String input) {
        StoreIllegalArgument exception = assertThrows(
                StoreIllegalArgument.class,
                () -> RequestValidator.validateString(input)
        );
