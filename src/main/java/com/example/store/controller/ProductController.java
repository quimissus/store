...
public class ProductController {
    ...
    public ProductDTO findProductById(@PathVariable Long productId) throws InterruptedException, StoreIllegalArgument, StoreValueNotFound, StoreValueNotFound, StoreIllegalArgument {
       return aggregatorService.findProductById(productId);
    }

    @GetMapping("/order/{productId}")
    @LogTime
    public ProductOrdersDTO findOrdersById(@PathVariable Long productId) throws InterruptedException, StoreIllegalArgument, StoreValueNotFound, StoreValueNotFound, StoreIllegalArgument {
